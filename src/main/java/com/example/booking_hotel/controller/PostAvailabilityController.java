...
public class AuthController {
    ...
    @PostMapping("/logout")
    ApiResponse<Void> logoutRenter(@RequestBody IntrospectRequest introspectRequest) throws ParseException, JOSEException {
        return authService.logout(introspectRequest.getToken());

    }

    @PostMapping("/refresh")
    ApiResponse<AuthResponse> refresh(@RequestBody IntrospectRequest introspectRequest) throws ParseException, JOSEException {
